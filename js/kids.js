(() => {
  ...
  const I18N = {
    it:{
      pageTitle:'Fablemarq Kids — Kiki Moon',description:'Fablemarq Kids: storie illustrate per bambini. Scopri Kiki Moon e La Stella Perduta.',skip:'Salta al contenuto',
      navKids:'Kids',navGamebooks:'Gamebooks',brand:'Fablemarq Kids',title:'Storie che crescono con l’immaginazione',lead:'Mondi illustrati, personaggi da ricordare e avventure da leggere insieme. Kiki Moon è il primo universo di Fablemarq Kids.',
      age:'6–10 anni',color:'80 pagine a colori',family:'Lettura condivisa',explore:'Scopri Kiki Moon',buy:'Acquista su Amazon',
      ...
      b2Label:'Libro II',b2Title:'Il Segreto di Snarfel',b2Text:'Il prossimo capitolo della saga è in lavorazione.',development:'In lavorazione',footer:'Fablemarq Kids — A Fablemarq publishing division',language:'Lingua'
    },
    en:{
      pageTitle:'Fablemarq Kids — Kiki Moon',description:'Fablemarq Kids: illustrated stories for children. Discover Kiki Moon and The Lost Star.',skip:'Skip to content',
      navKids:'Kids',navGamebooks:'Gamebooks',brand:'Fablemarq Kids',title:'Stories that grow with imagination',lead:'Illustrated worlds, memorable characters and adventures made to read together. Kiki Moon is the first universe of Fablemarq Kids.',
      age:'Ages 6–10',color:'80 full-color pages',family:'Made for shared reading',explore:'Discover Kiki Moon',buy:'Buy on Amazon',
      ...
      b2Label:'Book II',b2Title:"Snarfel's Secret",b2Text:'The next chapter of the saga is in development.',development:'In development',footer:'Fablemarq Kids — A Fablemarq publishing division',language:'Language'
    },
    es:{
      pageTitle:'Fablemarq Kids — Kiki Moon',description:'Fablemarq Kids: historias ilustradas para niños. Descubre Kiki Moon y La Estrella Perdida.',skip:'Saltar al contenido',
      navKids:'Kids',navGamebooks:'Gamebooks',brand:'Fablemarq Kids',title:'Historias que crecen con la imaginación',lead:'Mundos ilustrados, personajes inolvidables y aventuras para leer juntos. Kiki Moon es el primer universo de Fablemarq Kids.',
      age:'6–10 años',color:'80 páginas a color',family:'Lectura compartida',explore:'Descubre Kiki Moon',buy:'Comprar en Amazon',
      ...
      b2Label:'Libro II',b2Title:'El Secreto de Snarfel',b2Text:'El próximo capítulo de la saga está en desarrollo.',development:'En desarrollo',footer:'Fablemarq Kids — A Fablemarq publishing division',language:'Idioma'
    }
  };
