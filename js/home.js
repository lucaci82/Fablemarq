(() => {
  ...
  const I18N = {
    it:{
      ...
      heroKicker:'Fablemarq · Editore indipendente',tagline:'Storie che non restano sulla pagina.',heroSub:'Mondi da immaginare. Storie da scegliere. Esperienze da ricordare.',heroPrimary:'Scopri Fablemarq',heroSecondary:'Esplora i nostri mondi',
    ...
    en:{
      ...
      heroKicker:'Fablemarq · Independent publisher',tagline:'Stories that do not stay on the page.',heroSub:'Worlds to imagine. Stories to choose. Experiences to remember.',heroPrimary:'Discover Fablemarq',heroSecondary:'Explore our worlds',
    ...
    es:{
      ...
      heroKicker:'Fablemarq · Editorial independiente',tagline:'Historias que no se quedan en la página.',heroSub:'Mundos para imaginar. Historias para elegir. Experiencias para recordar.',heroPrimary:'Descubre Fablemarq',heroSecondary:'Explora nuestros mundos',
